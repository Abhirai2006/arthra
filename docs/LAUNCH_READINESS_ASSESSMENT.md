...
| Legal/privacy | Privacy and Terms identify **Abhishek Rai A, individual operator**, the **25 August 2026** effective date, a private Contact-page support/privacy route, 90-day post-resolution Contact retention, Waitlist deletion on consent withdrawal or 12 months of inactivity, and an 18+ audience boundary. | **Published factual baseline; legal review still needed** | Obtain jurisdiction-specific legal review, an account-data retention/deletion policy, processor/subprocessor disclosure, and a complete incident/grievance process before broad public collection of financial data. |
...
The public Privacy and Terms pages now state the operator, effective date, Contact-page privacy route, Contact/Waitlist retention rules, and 18+ boundary confirmed by the operator. The privacy route is a form rather than an invented email mailbox: requests should use “Privacy request” in the subject and are visible only in Owner Operations. Before broad launch, expand the package with confirmed financial-account retention/deletion rules, service providers/subprocessors, cross-border handling where applicable, a privacy-request response practice, incident contact, and a grievance/escalation route. This is not legal advice; an India-qualified privacy lawyer should review the final public text and operating practices.
...
4. The published privacy/terms baseline is reviewed by counsel; financial-account deletion/retention, processors, incident/grievance process, and support response practice are completed.
