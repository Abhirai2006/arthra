...
| P2 | Build a small, structured feedback loop | One public comment is a clue, not a roadmap. | Invite a small controlled-beta cohort to answer the same five onboarding/trust questions and record themes privately. Do not copy a social-media comment into the public-feedback section without the author submitting feedback through the disclosed public form. |
