...
- [ ] Rewrite GitHub commit attribution so the Manus agent is no longer listed as an Arthra contributor, then verify repository integrity and contributor metadata.
