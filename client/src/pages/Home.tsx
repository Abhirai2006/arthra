...
export default function Home() {
  ...
  return <main className="arthra-site">
    <section className="arthra-hero" ref={heroRef} onMouseMove={trackHero} style={pointerVariables}>
      ...
      <nav className="mobile-quick-nav" aria-label="Mobile quick navigation"><a href="#why-arthra">Why</a><a href="#flows">Flow</a><a href="#trust">Private</a><button type="button" onClick={handlePrimaryAction}>{isAuthenticated ? "Open" : "Start"}<ArrowRight size={15} /></button></nav>
